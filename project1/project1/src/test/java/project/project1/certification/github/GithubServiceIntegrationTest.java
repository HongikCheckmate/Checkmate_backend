...
//
//        LocalDateTime goalStartTime = LocalDateTime.now(ZoneOffset.UTC).minusDays(2);
//        githubGoal.setCreatedDate(goalStartTime); // 2일전부터 시작된 목표
//        githubGoal.setCycle(3); // 주기는 3일
//
//        githubGoal.setTargetRepository(testUsername + "/test-repo"); // 예시 값
//
//        goal = goalRepository.saveAndFlush(githubGoal);
//
